...
export const useCreateAlbumMutation = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message = error.data?.statusMessage || error.message || 'Create failed'
      toast.add({
        title: 'Create failed',
        description: message,
        color: 'red',
...
export const useUploadImagesMutation = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['album-images', variables.slug] })
    },
    onError: (error: any) => {
      const message = error.data?.statusMessage || error.message || 'Upload failed'
      toast.add({
        title: 'Upload failed',
        description: message,
        color: 'red',
...
export const useDeleteImageMutation = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message = error.data?.statusMessage || error.message || 'Delete failed'
      toast.add({
        title: 'Delete failed',
        description: message,
        color: 'red',
...
export const useTogglePromotedMutation = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message = error.data?.statusMessage || error.message || 'Update failed'
      toast.add({
        title: 'Update failed',
        description: message,
        color: 'red',
...
export const useUpdateAlbumMutation = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message = error.data?.statusMessage || error.message || 'Save failed'
      toast.add({
        title: 'Save failed',
        description: message,
        color: 'red',
